...
public class FragementWishlist extends Fragment {
    View v;
    private RecyclerView recyclerView;
    private List<CategoryModel> lstCategory;
    private static final String PRODUCT_URL = "http://192.168.1.11/shubhamNav/handicraft.php";
    CategoryRecyclerViewAdapter categoryRecyclerViewAdapter;

    public FragementWishlist() {
